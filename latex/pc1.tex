...
La operación \lstinline{medio sumador} esta representada por las siguientes ecuaciones:
...
Ambas ecuaciones comparten las mismas entradas, por lo tanto, realizar ambas en el mismo circuito.
...
Suba sus comandos en el orden en que deben ser ejecutados en el archivo \lstinline{pregunta4.sql} o \lstinline{pregunta4.txt} en su defecto.
